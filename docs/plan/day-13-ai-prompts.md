...
- docs/plan/day-12-ai-prompts.md
...
Quan trọng:
- UI All Investigations từng có ảnh mock legacy; các ảnh này đã được xóa khỏi repository sau bảo vệ.
...
Đọc trước:
- README.md
- docs/plan/day-06-prompt-v0.dev-part1.md
- docs/plan/day-12-ai-prompts.md
- Legacy UI reference đã xóa khỏi repository.
...
1. Kiểm tra trạng thái repository trước khi sửa.
2. Đọc UI mock legacy đã xóa khỏi repository (legacy, removed) và các component frontend hiện có để hiểu visual/layout trước khi sửa code.
...
11. Trang này phải giữ visual direction của mock trong bộ mock legacy đã xóa khỏi repository:
...
26. Không yêu cầu AI generate UI mới từ đầu vì mock legacy đã được xóa khỏi repository. Hãy yêu cầu AI:
...
Quan trọng:
- Dashboard UI từng có ảnh mock legacy; các ảnh này đã được xóa khỏi repository sau bảo vệ.
...
10. Nếu mock dashboard legacy đã có component tương ứng, refactor/tái sử dụng component đó. Nếu chưa có file rõ ràng, tạo page/component riêng, ví dụ `SocOverviewDashboard`, nhưng phải bám sát visual direction đã được triển khai lại trong component hiện tại.
...
27. Không yêu cầu AI generate dashboard UI mới từ đầu vì mock legacy đã được xóa khỏi repository (legacy, removed). Hãy yêu cầu AI:
...
- docs/architecture.md
- docs/sequence-flow.md
- docs/plan/day-13-ai-prompts.md
