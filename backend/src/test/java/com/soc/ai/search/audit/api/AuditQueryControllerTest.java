...
class AuditQueryControllerTest {
    ...
    void returnsPaginatedHistory() throws Exception {
        when(queryService.history(org.mockito.ArgumentMatchers.eq(0), org.mockito.ArgumentMatchers.eq(20), org.mockito.ArgumentMatchers.any(com.soc.ai.search.audit.api.AuditLogFilters.class))).thenReturn(new PagedResponse<>(
    ...
    void returnsPaginatedAuditLogs() throws Exception {
        when(queryService.auditLogs(org.mockito.ArgumentMatchers.eq(0), org.mockito.ArgumentMatchers.eq(50), org.mockito.ArgumentMatchers.any(com.soc.ai.search.audit.api.AuditLogFilters.class))).thenReturn(new PagedResponse<>(
                List.of(),
                0,
                50,
                0,
    ...
    void returnsBadRequestForInvalidPagination() throws Exception {
        when(queryService.history(org.mockito.ArgumentMatchers.eq(-1), org.mockito.ArgumentMatchers.eq(20), org.mockito.ArgumentMatchers.any(com.soc.ai.search.audit.api.AuditLogFilters.class)))
    ...
    void returnsControlledErrorWhenPostgresLookupFails() throws Exception {
        when(queryService.auditLogs(org.mockito.ArgumentMatchers.eq(0), org.mockito.ArgumentMatchers.eq(50), org.mockito.ArgumentMatchers.any(com.soc.ai.search.audit.api.AuditLogFilters.class)))
