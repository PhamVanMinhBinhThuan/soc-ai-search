...
class SearchPlanPromptBuilderTest {
    ...
    void systemPromptContainsSeedVocabularyAndStructuredMappingGuidance() {
        ...
        assertThat(prompt)
                ...
                .contains("Use filters.source for source/vendor/log-origin filters")
                .contains("Use aggregation.field = \"source\"")
                .contains("Supported source filter values")
                ...
                .contains("\"privilege escalation\", \"leo thang Ä‘áº·c quyá»n\" -> event_type [\"privilege_escalation\"]")
                .contains("\"malware\", \"malware detected\", \"mÃ£ Ä‘á»™c\" -> event_type [\"malware_detected\"]")
