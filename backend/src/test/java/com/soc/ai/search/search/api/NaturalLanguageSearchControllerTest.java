...
class NaturalLanguageSearchControllerTest {
    ...
    void naturalLanguageSearchReturnsAggregationResponse() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/search")
                        ...
                        .content("""
                                {
                                  "question": "Äáº¿m sá»‘ láº§n login tháº¥t báº¡i theo tá»«ng user trong 7 ngÃ y qua",
                                  "page": 0,
                                  "size": 5
                                }
                                """))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.original_question").value("Äáº¿m sá»‘ láº§n login tháº¥t báº¡i theo tá»«ng user trong 7 ngÃ y qua"))
    ...
    private NaturalLanguageSearchResponse aggregationResponse() {
        return new NaturalLanguageSearchResponse(
                ...
                "Äáº¿m sá»‘ láº§n login tháº¥t báº¡i theo tá»«ng user trong 7 ngÃ y qua",
