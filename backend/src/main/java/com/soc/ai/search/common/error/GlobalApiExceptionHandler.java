package com.soc.ai.search.common.error;
...
import com.soc.ai.search.export.domain.CsvExportConflictException;
import com.soc.ai.search.export.domain.CsvExportDependencyException;
import com.soc.ai.search.export.domain.CsvExportNotFoundException;
import com.soc.ai.search.search.api.SearchErrorResponse;
import com.soc.ai.search.search.application.SearchExecutionException;
import com.soc.ai.search.search.application.NaturalLanguageSearchException;
import com.soc.ai.search.search.application.NaturalLanguageSearchRateLimitException;
import com.soc.ai.search.search.refinement.application.QueryRefinementException;
