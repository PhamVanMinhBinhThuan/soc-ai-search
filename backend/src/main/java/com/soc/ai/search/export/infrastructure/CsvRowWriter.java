...
public final class CsvRowWriter {
    ...
    public CsvRowWriter(OutputStream outputStream) throws IOException {
    ...
    public void writeSearchEvent(SearchEvent event) throws IOException {
        writeTextRow(List.of(
    ...
    public void writeAggregationHeader() throws IOException {
        writeTextRow(List.of("key", "value"));
    }

    public void writeAggregationResult(AggregationResultItem item) throws IOException {
