...
import com.soc.ai.search.audit.application.SearchQueryLogLookupService;
...
import com.soc.ai.search.export.infrastructure.CsvRowWriter;
import com.soc.ai.search.export.infrastructure.ExportSearchExecutor;
...
public class CsvExportService {
    ...
    private long writeSearchEvents(
            CsvRowWriter writer,
            java.util.List<com.soc.ai.search.search.domain.result.SearchEvent> events,
