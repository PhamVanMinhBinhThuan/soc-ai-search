import { ApiError, apiUrl, authHeaders, errorPayload, isRecord, requestJson } from '@/shared/services/api/api-client'
import { getMockSearchHistory, getMockSearchHistoryDetail, mockTogglePinHistory } from '@/features/search/services/mock-search-api'
...
export async function getAuditLogs(
  ...
  items: import('@/shared/types/soc').AuditLogItem[]
  page: number
  size: number
  total: number
  total_pages: number
  ...
  return {
    items: payload.items as import('@/shared/types/soc').AuditLogItem[],
