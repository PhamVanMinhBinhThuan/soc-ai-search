...
import { parseQuestionForList, type AuditQuestionListParts } from "@/shared/lib/audit-question-format"
import { downloadCsvBlob } from "@/features/search/services/csv-export-api"
import { exportAuditLogs, getAuditLogs, getSearchHistoryDetail } from "@/features/investigations/services/history-api"
import type { AuditLogItem, AuditStatus, SearchHistoryDetailDto, SearchMode } from "@/shared/types/soc"
import { ModeBadge, StatusBadge } from "@/features/investigations/components/investigation-badges"
import { InvestigationDetailPanel } from "@/features/investigations/components/investigation-detail-panel"
