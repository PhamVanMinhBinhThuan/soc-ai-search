...
import { searchMockEvents } from "@/features/search/services/mock-search-api";
import {
  assertSearchPlanResponse,
  normalizeSearchPlanResponse,
} from "@/shared/services/api/search-plan-response";
import type { NaturalLanguageSearchResponseDto, SearchPlanDto } from "@/shared/types/soc";
