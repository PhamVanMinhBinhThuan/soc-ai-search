...
export const QUERY_LIBRARY_ITEMS: QueryLibraryItem[] = [
  ...
  {
    id: 'search-large-transfer-finance-30d',
    question: 'Show large transfer events for finance.user in the last 30 days',
    categories: ['search', 'multi_filter'],
    badges: ['SEARCH', 'MULTI-FILTER'],
    expectedView: 'event_logs_table',
    tags: ['large_transfer', 'finance.user', '30d', 'proxy'],
  },
  {
    id: 'search-data-exfiltration-30d',
    question: 'Show data exfiltration events in the last 30 days',
    categories: ['search'],
    badges: ['SEARCH'],
    expectedView: 'event_logs_table',
    tags: ['data_exfiltration', '30d', 'proxy'],
  },
  {
    id: 'search-dns-query-24h',
    question: 'Show DNS query events in the last 24 hours',
    categories: ['search'],
    badges: ['SEARCH'],
    expectedView: 'event_logs_table',
    tags: ['dns_query', 'dns', '24h'],
  },
  {
    id: 'search-process-start-edr-7d',
    question: 'Show process start events from EDR in the last 7 days',
    categories: ['search', 'multi_filter'],
    badges: ['SEARCH', 'MULTI-FILTER'],
    expectedView: 'event_logs_table',
    tags: ['process_start', 'edr', '7d'],
  },
  ...
  {
    id: 'count-large-transfer-30d',
    question: 'Count large transfer events in the last 30 days',
    categories: ['aggregation', 'count'],
    badges: ['COUNT'],
    expectedView: 'number',
    tags: ['count', 'large_transfer', '30d'],
  },
  {
    id: 'count-successful-login-24h',
    question: 'Count successful login events in the last 24 hours',
    categories: ['aggregation', 'count'],
    badges: ['COUNT'],
    expectedView: 'number',
    tags: ['count', 'successful_login', '24h'],
  },
  {
    id: 'count-cn-24h',
  ...
  {
    id: 'bar-outbound-by-country-30d',
    question: 'Group suspicious outbound events by country code in the last 30 days',
    categories: ['aggregation', 'bar_chart'],
    badges: ['AGGREGATION', 'BAR', 'GROUP BY'],
    expectedView: 'bar_chart',
    tags: ['suspicious_outbound', 'country_code', '30d', 'group by'],
  },
  {
    id: 'bar-large-transfer-by-user-30d',
    question: 'Group large transfer events by user in the last 30 days',
    categories: ['aggregation', 'bar_chart'],
    badges: ['AGGREGATION', 'BAR', 'GROUP BY'],
    expectedView: 'bar_chart',
    tags: ['large_transfer', 'user', '30d', 'group by'],
  },
  {
  ...
  {
    id: 'topn-lockout-users-7d',
    question: 'Show top users affected by account lockout in the last 7 days',
    categories: ['aggregation', 'top_n', 'bar_chart'],
    badges: ['TOP N', 'BAR'],
    expectedView: 'bar_chart',
    tags: ['user', 'account_lockout', '7d', 'top users'],
  },
  {
    id: 'topn-malware-hosts-30d',
    question: 'Show top hosts with malware detections in the last 30 days',
    categories: ['aggregation', 'top_n', 'bar_chart'],
    badges: ['TOP N', 'BAR'],
    expectedView: 'bar_chart',
    tags: ['host', 'malware_detected', '30d', 'top hosts'],
  },
  {
    id: 'topn-outbound-countries-30d',
    question: 'Show top countries for suspicious outbound activity in the last 30 days',
    categories: ['aggregation', 'top_n', 'bar_chart'],
    badges: ['TOP N', 'BAR'],
    expectedView: 'bar_chart',
    tags: ['country_code', 'suspicious_outbound', '30d', 'top countries'],
  },
  {
    id: 'topn-large-transfer-users-30d',
    question: 'Show top users with large transfer events in the last 30 days',
    categories: ['aggregation', 'top_n', 'bar_chart'],
    badges: ['TOP N', 'BAR'],
    expectedView: 'bar_chart',
    tags: ['user', 'large_transfer', '30d', 'top users'],
  },
  ...
  {
    id: 'line-lockout-trend-7d',
    question: 'Show account lockout trend by hour in the last 7 days',
    categories: ['time_series', 'line_chart', 'aggregation'],
    badges: ['AGGREGATION', 'LINE', 'TIME SERIES'],
    expectedView: 'line_chart',
    tags: ['account_lockout', '7d', 'trend'],
  },
  {
    id: 'line-malware-trend-30d',
    question: 'Show malware detected trend by day in the last 30 days',
    categories: ['time_series', 'line_chart', 'aggregation'],
    badges: ['AGGREGATION', 'LINE', 'TIME SERIES'],
    expectedView: 'line_chart',
    tags: ['malware_detected', '30d', 'trend'],
  },
  {
    id: 'line-outbound-trend-30d',
    question: 'Show suspicious outbound trend by day in the last 30 days',
    categories: ['time_series', 'line_chart', 'aggregation'],
    badges: ['AGGREGATION', 'LINE', 'TIME SERIES'],
    expectedView: 'line_chart',
    tags: ['suspicious_outbound', '30d', 'trend'],
  },
  {
    id: 'line-process-start-trend-24h',
    question: 'Show process start trend by hour in the last 24 hours',
    categories: ['time_series', 'line_chart', 'aggregation'],
    badges: ['AGGREGATION', 'LINE', 'TIME SERIES'],
    expectedView: 'line_chart',
    tags: ['process_start', '24h', 'trend'],
  },
  {
    id: 'line-events-12h',
  ...
  {
    id: 'multi-high-critical-failed-login-cn-24h',
    question: 'Show high or critical failed login events from China in the last 24h',
    categories: ['search', 'multi_filter'],
    badges: ['SEARCH', 'MULTI-FILTER'],
    expectedView: 'event_logs_table',
    tags: ['failed_login', 'high', 'critical', 'CN', '24h'],
  },
  {
  ...
  {
    id: 'playbook-service-account-outbound-30d',
    question: 'Investigate service account outbound activity by svc.backup in the last 30 days',
    categories: ['playbook', 'search'],
    badges: ['PLAYBOOK', 'SEARCH'],
    expectedView: 'event_logs_table',
    tags: ['svc.backup', 'suspicious_outbound', 'large_transfer', '30d', 'investigation'],
  },
  {
